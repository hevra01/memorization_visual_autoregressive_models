...
from memorization.data_prep.subset_imagenet import get_balanced_subset, IndexedDataset
...
def parse_args():
    ...
    p.add_argument("--output_dir", type=str, default="/scratch/inf0/user/hpetekka/var_mem/output_activation_all_prev_scales/", help="Directory to store activation files")
